...
module _ = struct
  ...
  let%expect_test " " =
    ...
    [%expect
      ...
      q=((_.16, false, true), 1);
      q=((false, true, _.19), 2);
      q=((_.22, _.23 [=/= true], false), 3);
      q=((_.30, _.31 [=/= false; =/= true], true), 4);
      q=((_.22 [=/= false], _.23, false), 3);
      q=((_.30 [=/= false], _.31 [=/= false], true), 4);
      } |}]
  ;;
  ...
  let%expect_test " " =
    ...
    [%expect
      ...
      q=((_.23, _.24 [=/= false; =/= true], true), 4);
      q=((_.23 [=/= false], _.24 [=/= false], true), 4);
      } |}]
  ;;
end
